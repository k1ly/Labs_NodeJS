...
function initialize(seq) {
    ...
    Profession.hasMany(Employee, {foreignKey: 'profession'});
    Employee.belongsTo(Profession, {foreignKey: 'profession'});
    Office.hasMany(Employee, {foreignKey: 'office'});
    Employee.belongsTo(Office, {foreignKey: 'office'});
...
exports.init = seq => {
    initialize(seq);
    return {Employee, Office, Job, JobType, Profession};
}